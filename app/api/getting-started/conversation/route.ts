...
import { runGettingStartedConversation } from "@/services/gettingStartedConversation/gettingStartedConversationService";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const { result, requestId: serviceRequestId } =
      await runGettingStartedConversation({
        organizationId,
        userId,
        body,
        requestId,
    ...
    console.error(
      JSON.stringify({
        event: "getting_started_conversation_unhandled_error",
        requestId,
