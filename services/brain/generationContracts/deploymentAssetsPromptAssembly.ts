...
/**
 * Canonical Deployment Assets prompt.
 * Prospects: full asset set (Gemini via prospect_deployment_assets).
 * Discussions: community asset set (Claude via deployment_assets).
 */
...
- Substack must be publication-ready long-form editorial content.
- Reddit must be transparent and community-native.
- Knowledge Base Enhancement must be factual and non-promotional.
...
Knowledge Base Enhancement uses only verified Prospect source facts — never invent.
