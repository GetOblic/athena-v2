...
export function buildStrategicBlueprintContract(
  ...
  return buildBaseContract(input, {
    ...
    mandatorySections: [
      ...
      "paste-ready image_prompt, pdf_prompt, social_prompt, and trend_social_prompt",
    ],
    validationRules: [
      ...
      "image_prompt, pdf_prompt, social_prompt, and trend_social_prompt must not duplicate each other",
      ...
      "trend_social_prompt must follow the current GetOblic Trend Social instruction when configured, remain distinct from social_prompt, and must not invent a substitute trend policy when that instruction is absent",
    ...
    forbiddenBehaviors: {
      behaviors: [
        ...
        "Do not repeat identical wording across image_prompt, pdf_prompt, social_prompt, and trend_social_prompt.",
