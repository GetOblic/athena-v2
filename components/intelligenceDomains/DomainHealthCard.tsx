...
export function DomainHealthCard({ health }: DomainHealthCardProps) {
  ...
  const stateColor = getDomainHealthStateColor(
    health.healthLabel as "Learning" | "Building" | "Confident" | "Mature",
  );
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-2xl border border-white/10 bg-black/20 px-5 py-4">
            ...
            {confidence != null ? (
              ...
              <p className="mt-3 text-xs leading-5 text-white/40">
                Athena will become more confident as more discussions are
                analyzed.
              </p>
            )}
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-black/20 px-5 py-4">
            ...
            <p className="mt-3 text-xs leading-5 text-white/40">
              Change since the previous domain intelligence refresh.
            </p>
          </div>
        </div>
      </div>
