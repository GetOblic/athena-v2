...
export function SeoRecommendationCard({
  ...
  const copyText = [
    title,
    why ? `Why Athena recommends this: ${why}` : "",
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        <CopyButton text={copyText} tracking={null} showContinue={false} />
      </div>

      <div className="mt-5 space-y-4 border-t border-white/10 pt-4">
        <FieldBlock label="Why Athena recommends this" value={why} emphasize />
        {evidence.length > 0 ? (
          <div className="space-y-1.5">
            <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-white/35">
              Evidence
        ...
        {impact ? (
          <FieldBlock label="Expected business impact" value={impact} />
        ) : null}
      </div>
